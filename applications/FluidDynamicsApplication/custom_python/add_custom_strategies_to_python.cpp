...
void  AddCustomStrategiesToPython()
{
    ...
    class_< GearScheme< SparseSpaceType, LocalSpaceType >,
            bases< BaseSchemeType >,  boost::noncopyable >
            ("GearScheme",init<unsigned int>())                                               // default constructor
            .def(init<unsigned int, const Kratos::Variable<double>&>())                       // default constructor with user-defined slip variable
            .def(init<unsigned int, Process::Pointer >())                                     // constructor passing a turbulence model
            .def(init<unsigned int, const Kratos::Variable<double>&, Process::Pointer >())    // constructor passing a turbulence model and user-defined slip variable
            ;
