...
namespace Kratos
{
	...
	LinearElasticOrthotropic2DLaw::LinearElasticOrthotropic2DLaw(const LinearElasticOrthotropic2DLaw& rOther)
	...
	{
		LinearElasticOrthotropic2DLaw::Pointer p_clone(new LinearElasticOrthotropic2DLaw(*this));
		return p_clone;
	}
