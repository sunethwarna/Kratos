...
const SmallDisplacementThermoMechanicGlobalDamageElement mSmallDisplacementThermoMechanicGlobalDamageElement2D3N;
const SmallDisplacementThermoMechanicGlobalDamageElement mSmallDisplacementThermoMechanicGlobalDamageElement2D6N;
const SmallDisplacementThermoMechanicGlobalDamageElement mSmallDisplacementThermoMechanicGlobalDamageElement2D4N;
const SmallDisplacementThermoMechanicGlobalDamageElement mSmallDisplacementThermoMechanicGlobalDamageElement2D8N;
const SmallDisplacementThermoMechanicGlobalDamageElement mSmallDisplacementThermoMechanicGlobalDamageElement2D9N;

const SmallDisplacementThermoMechanicGlobalDamageElement mSmallDisplacementThermoMechanicGlobalDamageElement3D4N;
const SmallDisplacementThermoMechanicGlobalDamageElement mSmallDisplacementThermoMechanicGlobalDamageElement3D10N;
const SmallDisplacementThermoMechanicGlobalDamageElement mSmallDisplacementThermoMechanicGlobalDamageElement3D8N;
const SmallDisplacementThermoMechanicGlobalDamageElement mSmallDisplacementThermoMechanicGlobalDamageElement3D20N;
const SmallDisplacementThermoMechanicGlobalDamageElement mSmallDisplacementThermoMechanicGlobalDamageElement3D27N;
