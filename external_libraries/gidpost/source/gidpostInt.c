...
int CPostFile_WriteValuesNS(CPostFile* this, int id, int n, double* values)
{
  assert(this);
...
int CPostFile_WriteValuesNSV(CPostFile* this, int id, int n, int num_comp, double* values)
{
  assert(this);
...
static
int CPostAscii_WriteValuesNS(CPostFile* this, int id, int n, double *buffer)
{
  int i;
  static char local_format[100];
  static int create_format=1;
...
static
int CPostAscii_WriteValuesNSV(CPostFile* this, int id, int n, int num_comp, double *buffer)
{
  int i;
  static char local_format[100];
  static int create_format=1;
...
static
int CPostAsciiZ_WriteValuesNS(CPostFile* this, int id, int n, double *buffer)
{
  int i;
  static char local_format[100];
  static int create_format=1;
...
static
int CPostAsciiZ_WriteValuesNSV(CPostFile* this, int id, int n, int num_comp, double *buffer)
{
  int i;
  static char local_format[100];
  static int create_format=1;
...
static
int CPostBinary_WriteValuesNS(CPostFile* this, int id, int n, double *buffer)
{
  int i;
  float value;
  assert(this);
...
static
int CPostBinary_WriteValuesNSV(CPostFile* this, int id, int n, int num_comp, double *buffer)
{
  int i;
  float value;
